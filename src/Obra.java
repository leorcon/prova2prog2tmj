...
public class Obra {
    ...
    public void emprestar(Emprestimo emp){
        if (this.atual != null){
            throw new IllegalArgumentException("Obra já se encontra emprestada"); 
        }
        if (emp == null){
            throw new IllegalArgumentException("Empréstimo não identificado"); 
        }
        this.atual = emp;
    }
    ...
    public void devolver(Emprestimo emp){
        if (this.atual == null){
            throw new IllegalArgumentException("Obra não se encontra emprestada"); 
        }
        if (emp == null){
            throw new IllegalArgumentException("Empréstimo não identificado"); 
        }
        if (this.atual != emp){
            throw new IllegalArgumentException("Não pode ser devolvida por empréstimo de outra obra");             
        }
        this.atual = null;
    }
